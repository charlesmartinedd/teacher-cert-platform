...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Mock login - in production, this would call an authentication API
    alert('This is a demo. In production, this would authenticate with your backend.');
  };
      ...
      <div className="max-w-md w-full">
        ...
        <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <p className="text-sm text-center text-blue-900">
            <strong>Demo Notice:</strong> This is a prototype. Authentication is mocked for demonstration purposes.
          </p>
        </div>
      </div>
    </div>
